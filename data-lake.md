...
![](https://github.com/user-attachments/assets/942cc8bf-beef-4105-8d18-de11fa92a704)
...
## 2. Sentinel MCP Server

Example usage in n8n

### 2.1. Setup Sentinel MCP app identity

![](https://github.com/user-attachments/assets/33df02d0-0288-49a2-9bf8-e36c4b836d25)

### 2.2. Configure API permission
